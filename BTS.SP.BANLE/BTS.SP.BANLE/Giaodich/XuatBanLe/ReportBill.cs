...
{
    public partial class ReportBill : XtraReport
    {
        public ReportBill()
        {
            InitializeComponent();
        ...
        // GIAO DỊCH BÁN LẺ
        public void InitDataBillBanLe(NVGDQUAY_ASYNCCLIENT_DTO _NVGDQUAY_ASYNCCLIENT_BILL_GLOBAL, BILL_DTO objecBillDto)
        {
