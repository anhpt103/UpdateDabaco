...
namespace BTS.SP.BANLE.Giaodich.XuatBanLe
{
    public partial class ReportBill_TraLai : XtraReport
    {
        ...
        {
            InitializeComponent();
            lblDate.Text = "HÓA ĐƠN HÀNG TRẢ LẠI  " + DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss");
        }
        // GIAO DỊCH BÁN LẺ
        public void InitDataBillBanLeTraLai(NVGDQUAY_ASYNCCLIENT_DTO _NVGDQUAY_ASYNCCLIENT_BILL_GLOBAL, BILL_DTO objecBillDto)
        {
