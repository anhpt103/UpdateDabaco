    ...
    public partial class frmGuiDuLieuBan : Form
    {
        ...
        public static void DongBoTatCaDuLieuBan()
        {
            ...
            try
            {
                ...
                using (OracleConnection connectionOracle = new OracleConnection(ConfigurationManager.ConnectionStrings["TBNETERP_SERVER"].ConnectionString))
                {
                    ...
                    if (connectionOracle.State == ConnectionState.Open)
                    {
                        try
                        {
                            using (SqlConnection connectionClient = new SqlConnection(ConfigurationManager.ConnectionStrings["TBNETERP_CLIENT"].ConnectionString))
                            {
