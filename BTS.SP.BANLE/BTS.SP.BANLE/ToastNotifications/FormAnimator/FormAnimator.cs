...
namespace BTS.SP.BANLE.ToastNotifications.FormAnimator
{
    public sealed class FormAnimator
    {
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            ...
            {
                NativeMethods.NativeMethods.AnimateWindow(_form.Handle, _duration, AwActivate | (int)_method | (int)_direction);
            }
        }
        ...
        private void Form_VisibleChanged(object sender, EventArgs e)
        {
            ...
            if (_form.MdiParent == null)
            {
                ...
                NativeMethods.NativeMethods.AnimateWindow(_form.Handle, _duration, flags);
            }
        }
        ...
        private void Form_Closing(object sender, CancelEventArgs e)
        {
            if (!e.Cancel)
            {
                ...
                if (_form.MdiParent == null || _method != AnimationMethod.Fade)
                {
                    NativeMethods.NativeMethods.AnimateWindow(_form.Handle, _duration, AwHide | (int)_method | (int)_direction);
                }
            }
        }
