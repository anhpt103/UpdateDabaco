define(['ui-bootstrap'], function () {
    ...
    app.controller('AuMenu_ctrl', ['$scope', '$location', '$http', 'configService', 'AuMenuService', 'tempDataService', '$filter', '$uibModal', '$log', 'ngNotify', 'securityService', 'toaster',
    ...
    app.controller('AuMenuDetails', ['$scope', '$uibModalInstance', '$location', '$http', 'configService', 'AuMenuService', 'tempDataService', '$filter', '$uibModal', '$log', 'ngNotify',
    ...
    /* controller delete */
    app.controller('AuMenuDelete', ['$scope', '$uibModalInstance', '$location', '$http', 'configService', 'AuMenuService', 'tempDataService', '$filter', '$uibModal', '$log', 'targetData', 'ngNotify',
    ...
    /* controller addNew */
    app.controller('AuMenuCreate', ['$scope', '$uibModalInstance', '$location', '$http', 'configService', 'AuMenuService', 'tempDataService', '$filter', '$uibModal', '$log', 'ngNotify',
        function ($scope, $uibModalInstance, $location, $http, configService, service, tempDataService, $filter, $uibModal, $log, ngNotify) {
            $scope.config = angular.copy(configService);
            $scope.tempData = tempDataService.tempData;
            $scope.target = {};
    ...
    /* controller addNew */
    app.controller('AuMenuEdit', ['$scope', '$uibModalInstance', '$location', '$http', 'configService', 'AuMenuService', 'tempDataService', '$filter', '$uibModal', '$log', 'ngNotify',
        function ($scope, $uibModalInstance, $location, $http, configService, service, tempDataService, $filter, $uibModal, $log, ngNotify) {
            $scope.config = angular.copy(configService);
            $scope.tempData = tempDataService.tempData;
            $scope.target = targetData;
