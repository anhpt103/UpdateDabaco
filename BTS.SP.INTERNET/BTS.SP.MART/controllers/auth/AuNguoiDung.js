define(['ui-bootstrap', '/BTS.SP.MART/controllers/auth/AuNguoiDungNhomQuyen.js', '/BTS.SP.MART/controllers/auth/AuNhomQuyen.js', '/BTS.SP.MART/controllers/auth/AuNguoiDungQuyen.js', '/BTS.SP.MART/controllers/auth/AuthController.js'], function () {
    ...
    app.controller('AuNguoiDungViewCtrl', ['$scope', '$location', '$http', 'configService', 'AuNguoiDungService', 'tempDataService', '$filter', '$uibModal', '$log', 'ngNotify', 'securityService', 'toaster', 'AuNguoiDungNhomQuyenService', 'AuNhomQuyenService', 'AuNguoiDungQuyenService',
        function ($scope, $location, $http, configService, service, tempDataService, $filter, $uibModal, $log, ngNotify, securityService, toaster, serviceAuNguoiDungNhomQuyen, serviceAuNhomQuyen, serviceAuNguoiDungQuyen) {
    ...
    app.controller('AuNguoiDungDetailsController', [
        '$scope', '$uibModalInstance',
        'configService', 'AuNguoiDungService', 'targetData', 'tempDataService',
        function ($scope, $uibModalInstance,
            configService, service, targetData, tempDataService) {
            $scope.config = angular.copy(configService);
            $scope.paged = angular.copy(configService.pageDefault);
            $scope.filtered = angular.copy(configService.filterDefault);
            $scope.tempData = tempDataService.tempData;
    ...
    app.controller('AuNguoiDungEditController', [
        '$scope', '$uibModalInstance', 'AuNguoiDungService', 'configService', 'tempDataService', '$filter', '$uibModal', '$log', 'ngNotify', 'targetData',
        function ($scope, $uibModalInstance, service, configService, tempDataService, $filter, $uibModal, $log, ngNotify, targetData) {
            $scope.config = angular.copy(configService);
            $scope.paged = angular.copy(configService.pageDefault);
            $scope.filtered = angular.copy(configService.filterDefault);
            $scope.tempData = tempDataService.tempData;
    ...
    app.controller('AuNguoiDungSelectDataController', ['$scope', '$uibModalInstance', '$location', '$http', 'configService', 'AuNguoiDungService', 'tempDataService', '$filter', '$uibModal', '$log', 'ngNotify', 'filterObject', 'serviceSelectData',
        function ($scope, $uibModalInstance, $location, $http, configService, service, tempDataService, $filter, $uibModal, $log, ngNotify, filterObject, serviceSelectData) {
            ...
            function filterData() {
                ...
                $scope.isLoading = true;
                var postdata = { paged: $scope.paged, filtered: $scope.filtered };
                service.postSelectData(JSON.stringify(postdata)).then(function (response) {
                    $scope.isLoading = false;
                    if (response.status) {
    ...
    /* controller delete */
    app.controller('AuNguoiDungDeleteController', ['$scope', '$uibModalInstance', '$location', '$http', 'configService', 'AuNguoiDungService', 'tempDataService', '$filter', '$uibModal', '$log', 'targetData', 'ngNotify',
    ...
    app.controller('AuNguoiDungChangePasswordController', ['$scope', '$uibModalInstance', '$location', '$http', 'configService', 'AuNguoiDungService', 'tempDataService', '$filter', '$uibModal', '$log', 'targetData', 'ngNotify', 'md5',
        function ($scope, $uibModalInstance, $location, $http, configService, service, tempDataService, $filter, $uibModal, $log, targetData, ngNotify, md5) {
            $scope.config = angular.copy(configService);
            $scope.targetData = angular.copy(targetData);
            $scope.target = targetData;
            $scope.isLoading = false;
