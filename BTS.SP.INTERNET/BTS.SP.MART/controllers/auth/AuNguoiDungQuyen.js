...
define(['ui-bootstrap'], function () {
    ...
    /* controller list */
    app.controller('AuNguoiDungQuyenCreateCtrl', ['$scope', '$location', '$http', '$uibModalInstance', 'configService', 'AuNguoiDungQuyenService', 'tempDataService', '$filter', '$uibModal', '$log', 'ngNotify', 'securityService', 'toaster', 'AuMenuService', 'targetData',
