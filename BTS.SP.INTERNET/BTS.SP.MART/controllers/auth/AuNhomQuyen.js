...
define(['ui-bootstrap', 'controllers/auth/AuNhomQuyenChucNang'], function () {
    ...
    /* controller list */
    app.controller('AuNhomQuyenViewCtrl', ['$scope', '$location', '$http', 'configService', 'AuNhomQuyenService', 'tempDataService', '$filter', '$uibModal', '$log', 'ngNotify', 'securityService', 'toaster',
