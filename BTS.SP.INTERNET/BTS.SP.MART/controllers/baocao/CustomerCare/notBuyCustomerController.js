...
* Menu: Nghiệp vụ-> Chăm sóc khách hàng lâu không mua hàng
*/
define(['ui-bootstrap', '/BTS.SP.MART/controllers/auth/AuthController.js', '/BTS.SP.MART/controllers/htdm/periodController.js', '/BTS.SP.MART/controllers/htdm/merchandiseController.js', '/BTS.SP.MART/controllers/htdm/customerController.js', '/BTS.SP.MART/controllers/htdm/merchandiseTypeController.js', '/BTS.SP.MART/controllers/htdm/nhomVatTuController.js', '/BTS.SP.MART/controllers/htdm/supplierController.js', '/BTS.SP.MART/controllers/htdm/wareHouseController.js', '/BTS.SP.MART/controllers/htdm/packagingController.js', '/BTS.SP.MART/controllers/htdm/taxController.js', '/BTS.SP.MART/controllers/htdm/donViTinhController.js'], function () {
    'use strict';
    var app = angular.module('notBuyCustomerModule', ['ui.bootstrap', 'authModule', 'periodModule', 'merchandiseModule', 'customerModule', 'merchandiseTypeModule', 'nhomVatTuModule', 'supplierModule', 'wareHouseModule', 'packagingModule', 'taxModule', 'donViTinhModule']);
    app.factory('notBuyCustomerService', ['$http', 'configService', function ($http, configService) {
        var serviceUrl = configService.rootUrlWebApi + '/Ac/CustomerCare';
        ...
        var result = {
            robot: calc,
            postNotBuyCustomer: function (data, callback) {
                $http.post(serviceUrl + '/PostNotBuyCustomer', data).success(callback);
            },
            getUnitUsers: function (callback) {
                $http.get(rootUrl + '/api/Authorize/AuDonVi/GetSelectDataByUnitCode').success(callback);
            },
            takeCareOfCustomer: function (params) {
                return $http.put(serviceUrl + '/' + params.id, params);
            },
            getNewParameter: function (callback) {
                $http.get(serviceUrl + '/GetNewParameter').success(callback);
            },
            postCreateReportNotBuyCustomer: function (data, callback) {
                $http.post(serviceUrl + '/ReportNotBuyCustomer', data).success(callback);
            }
        }
        return result;
    }]);
    /* controller list */
    app.controller('notBuyCustomerController', [
        '$scope', '$location', '$http', 'configService', 'notBuyCustomerService', 'tempDataService', '$filter', '$uibModal', '$log', 'ngNotify', 'securityService', '$rootScope', 'toaster', 'periodService', 'merchandiseService', 'customerService', 'merchandiseTypeService', 'nhomVatTuService', 'supplierService', 'wareHouseService', 'packagingService', 'taxService', 'donViTinhService', '$state',
        function ($scope, $location, $http, configService, service, tempDataService, $filter, $uibModal, $log, ngNotify, securityService, $rootScope, toaster, servicePeriod, serviceMerchandise, serviceCustomer, serviceMerchandiseType, serviceNhomVatTu, serviceSupplier, serviceWareHouse, servicePackaging, serviceTax, serviceDonViTinh, $state) {
            ...
            function filterData() {
                ...
                service.getUnitUsers(function (response) {
                    console.log('getUnitUsers', response);
            ...
            function loadAccessList() {
                securityService.getAccessList('notBuyCustomer').then(function (successRes) {
            ...
            $scope.report = function () {
                $state.go('notBuyCustomerReport', { obj: $scope.target });
            }
    ...
    /* controller reportNotBuyCustomerController */
    app.controller('reportNotBuyCustomerController', ['$scope', '$uibModalInstance', '$location', '$http', 'configService', 'notBuyCustomerService', 'tempDataService', '$filter', '$uibModal', '$log', 'ngNotify', '$rootScope', 'userService', 'merchandiseService', 'customerService', 'merchandiseTypeService', 'nhomVatTuService', 'supplierService', 'wareHouseService', 'packagingService', 'taxService', 'donViTinhService', 'periodService', '$state',
        function ($scope, $uibModalInstance, $location, $http, configService, service, tempDataService, $filter, $uibModal, $log, ngNotify, $rootScope, serviceAuthUser, serviceMerchandise, serviceCustomer, serviceMerchandiseType, serviceNhomVatTu, serviceSupplier, serviceWareHouse, servicePackaging, serviceTax, serviceDonViTinh, servicePeriod, $state) {
            ...
            $scope.goIndex = function () {
                $state.go('notBuyCustomer');
            };
            if (para) {
                service.postCreateReportNotBuyCustomer(para, function (response) {
                    if (response != null) {
