...
define(['ui-bootstrap', '/BTS.SP.MART/controllers/auth/AuthController.js', '/BTS.SP.MART/controllers/auth/AuNguoiDung.js', '/BTS.SP.MART/controllers/htdm/periodController.js', '/BTS.SP.MART/controllers/htdm/supplierController.js', '/BTS.SP.MART/controllers/htdm/merchandiseController.js'], function () {
    ...
    app.controller('phieuNgayHetHanHangHoaController', [
        '$scope', '$http', 'configService', 'phieuNgayHetHanHangHoaService', 'tempDataService', '$uibModal', '$log', 'ngNotify', 'securityService', 'toaster', 'periodService',
        function ($scope, $http, configService, service, tempDataService, $uibModal, $log, ngNotify, securityService, toaster, servicePeriod) {
    ...
    app.controller('phieuNgayHetHanHangHoaCreateController', ['$scope', '$uibModalInstance', 'configService', 'phieuNgayHetHanHangHoaService', 'tempDataService', '$uibModal', 'ngNotify', 'userService', 'toaster', 'merchandiseService', 'supplierService', '$filter',
        function ($scope, $uibModalInstance, configService, service, tempDataService, $uibModal, ngNotify, serviceAuthUser, toaster, serviceMerchandise, serviceSupplier, $filter) {
            ...
            var rootUrl = configService.apiServiceBaseUri;
            var serviceUrl = rootUrl + '/api/Nv/NgayHetHanHangHoa';
            $scope.config = angular.copy(configService);
            $scope.paged = angular.copy(configService.pageDefault);
    ...
    /* controller Edit */
    app.controller('phieuNgayHetHanHangHoaEditController', ['$scope', '$uibModalInstance', 'configService', 'phieuNgayHetHanHangHoaService', 'tempDataService', '$uibModal', 'targetData', 'ngNotify', 'merchandiseService', 'toaster', 'AuNguoiDungService', 'supplierService', '$filter',
        function ($scope, $uibModalInstance, configService, service, tempDataService, $uibModal, targetData, ngNotify, serviceMerchandise, toaster, AuNguoiDungService, serviceSuppliers, $filter) {
            $scope.config = angular.copy(configService);
            $scope.paged = angular.copy(configService.pageDefault);
    ...
    /* controller Details */
    app.controller('phieuNgayHetHanHangHoaDetailsController', ['$scope', '$uibModalInstance', 'configService', 'phieuNgayHetHanHangHoaService', 'tempDataService', '$uibModal', 'targetData', 'ngNotify', 'AuNguoiDungService',
        function ($scope, $uibModalInstance, configService, service, tempDataService, $uibModal, targetData, ngNotify, AuNguoiDungService) {
            $scope.config = angular.copy(configService);
            $scope.paged = angular.copy(configService.pageDefault);
            $scope.targetData = angular.copy(targetData);
            $scope.tempData = tempDataService.tempData;
                    ...
                    if (resgetDetails.status) {
                        ...
                        angular.forEach($scope.target.dataDetails, function (v, k) {
                            if ($scope.target.dataDetails[k].ngayHetHan) {
                                var timeDiff2 = ((new Date($scope.target.dataDetails[k].ngayHetHan)).getTime() - (new Date()).getTime());
                                $scope.target.dataDetails[k].conLai_NgayHetHan = Math.ceil(timeDiff2 / (1000 * 3600 * 24));
                                console.log($scope.target.dataDetails[k].conLai_NgayHetHan);
                            }
                        });
                    }
                    $scope.isLoading = false;
    ...
    /* controller delete */
    app.controller('phieuNgayHetHanHangHoaDeleteController', ['$scope', '$uibModalInstance', 'configService', 'phieuNgayHetHanHangHoaService', 'tempDataService', '$uibModal', 'targetData', 'ngNotify',
        function ($scope, $uibModalInstance, configService, service, tempDataService, $uibModal, targetData, ngNotify) {
            $scope.config = angular.copy(configService);
            $scope.targetData = angular.copy(targetData);
            $scope.target = targetData;
            $scope.isLoading = false;
